...
ActiveRecord::Schema[7.1].define(version: 2025_06_04_112941) do
  ...
  create_table "crime_map_configs", force: :cascade do |t|
    t.string "key"
    t.decimal "value"
    t.datetime "created_at", null: false
  ...
  create_table "crime_postcode_exclusions", force: :cascade do |t|
    t.string "postcode"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
